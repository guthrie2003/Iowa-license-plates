# Iowa-license-plates
This is a collection of Iowa License plate designs - including counties - for Tesla's latest software update.

Required: a USB device
Tesla with 2024.38 or above

Instructions:
1.  Create a folder on the root directory of the USB device name "LicensePlate", e.g. F:\LicensePlate or /mnt/usbstick/LicensePlate
